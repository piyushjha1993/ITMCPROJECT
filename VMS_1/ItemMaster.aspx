<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemMaster.aspx.cs" Inherits="VMS_1.ItemMaster" %>
...
<body>
    ...
    <div class="container">
                 ...
                 <table class="table" id="myTable">
                  ...
                  <tbody id="tableBody" runat="server">
                        <tr>
                            ...
                            <td><input type="number" class="form-control" name = "officerScale" required min="0" step="0.001"/></td>
                            <td><input type="number" class="form-control" name="sailorScale" required min="0" step="0.001"/></td>
      ...
      <tbody id="Tbody1" runat="server">
            <tr>
                <td><input type="text" class="form-control" name="alternateitemname" /></td>
